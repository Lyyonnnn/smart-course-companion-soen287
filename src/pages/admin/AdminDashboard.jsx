    ...
    return (
        <>
                ...
                <div className="stats shadow w-1/2">
                    <div className="stat">
                        <div className="stat-figure">
                            <img
                                src="https://img.icons8.com/?size=100&id=85057&format=png&color=000000"
                                alt="Group"
                                className="w-10"
                            />
                        </div>
                    ...
                    <div className="stat">
                        <div className="stat-figure">
                            <img
                                src="https://img.icons8.com/?size=100&id=82464&format=png&color=000000"
                                alt="Book"
                                className="w-10"
                            />
                        </div>
                    ...
                    <div className="stat">
                        <div className="stat-figure">
                            <img
                                src="https://img.icons8.com/?size=100&id=85929&format=png&color=000000"
                                alt="Light Bulb"
                                className="w-10"
                            />
                        </div>
                                ...
                                <li key={index} className="list-row">
                                    ...
                                    <div className="flex flex-row ml-auto gap-3 items-center">
                                        <button
                                            ...
                                            onClick={() =>
                                                document
                                                    .getElementById(`${course.name}_${index}_view_modal`)
                                                    .showModal()
                                            }
                                        >
                                            <img
                    ...
                    <div className="tab-content bg-base-100 border-base-300 p-6">
                        <fieldset className="fieldset bg-base-200 border-base-300 rounded-box border p-4">
                            ...
                            <input
                                ...
                                placeholder="Differential & Integral Calculus II"
                            />
            ...
            {courses.map((course, index) => (
                <dialog
                    key={index}
                    id={`${course.name}_${index}_view_modal`}
                    className="modal"
                >
                    <div className="modal-box">
                        ...
                        <p className="font-bold mt-5">Course Assessments</p>
